...
OUTPUT_DIR=${OUTPUT_DIR:-"$ROOT_DIR/dist/xiaoxin-tui"}
...
if command -v xmllint >/dev/null 2>&1; then
  xmllint --noout "$SRC_DIR/background.svg" "$SRC_DIR/highlight.svg" "$SRC_DIR/icons/arch.svg" "$SRC_DIR/icons/windows.svg"
fi
