...
rsvg-convert -w 6 -h 28 "$SHARED_SRC_DIR/progress-track-w.svg" -o "$OUTPUT_DIR/progress-track_w.png"
rsvg-convert -w 1 -h 28 "$SHARED_SRC_DIR/progress-track-c.svg" -o "$OUTPUT_DIR/progress-track_c.png"
rsvg-convert -w 6 -h 28 "$SHARED_SRC_DIR/progress-track-e.svg" -o "$OUTPUT_DIR/progress-track_e.png"
rsvg-convert -w 6 -h 28 "$SHARED_SRC_DIR/progress-fill-w.svg" -o "$OUTPUT_DIR/progress-fill_w.png"
rsvg-convert -w 1 -h 28 "$SHARED_SRC_DIR/progress-fill-c.svg" -o "$OUTPUT_DIR/progress-fill_c.png"
rsvg-convert -w 6 -h 28 "$SHARED_SRC_DIR/progress-fill-e.svg" -o "$OUTPUT_DIR/progress-fill_e.png"
